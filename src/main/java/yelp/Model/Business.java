...
public class Business {
    ...
    public Business(String id, String name, String address, String postalCode, double stars, boolean open, Time monday_open, Time monday_close, Time tuesday_open, Time tuesday_close, Time wednesday_open, Time wednesday_close, Time thursday_open, Time thursday_close, Time friday_open, Time friday_close, Time saturday_open, Time saturday_close, Time sunday_open, Time sunday_close, String credit_cards, String car_parking, String bike_parking, String wheelchair_accessible, String happy_hour, String outdoor_seating) {
        this.id = id;
        this.name = name;
